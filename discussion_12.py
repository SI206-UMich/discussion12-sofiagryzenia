...
def create_employee_table(cur, conn):
    cur.execute("CREATE TABLE IF NOT EXISTS Employees (employee_id INTEGER PRIMARY KEY, first_name TEXT, last_name TEXT, job_id INT, hire_date TEXT, salary INT)")
    conn.commit()
...
def job_and_hire_date(cur, conn):
    ...
    sorted_job_and_hire_date = sorted(job_and_hire_date, key=lambda i : i[0])
    return sorted_job_and_hire_date[0][1] #get the smallest value
